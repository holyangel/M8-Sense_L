...
#define ov13850_1140m_SENSOR_NAME "ov13850_1140m"
...
static struct msm_sensor_power_setting ov13850_1140m_power_setting[] = {
...
static struct v4l2_subdev_info ov13850_1140m_subdev_info[] = {
	{
...
static const struct i2c_device_id ov13850_1140m_i2c_id[] = {
	{ov13850_1140m_SENSOR_NAME, (kernel_ulong_t)&ov13850_1140m_s_ctrl},
	{ }
};

static int32_t msm_ov13850_1140m_i2c_probe(struct i2c_client *client,
	const struct i2c_device_id *id)
{
	return msm_sensor_i2c_probe(client, id, &ov13850_1140m_s_ctrl);
}

static struct i2c_driver ov13850_1140m_i2c_driver = {
	.id_table = ov13850_1140m_i2c_id,
	.probe  = msm_ov13850_1140m_i2c_probe,
	.driver = {
		.name = ov13850_1140m_SENSOR_NAME,
	},
};

static struct msm_camera_i2c_client ov13850_1140m_sensor_i2c_client = {
	.addr_type = MSM_CAMERA_I2C_WORD_ADDR,
};

static const struct of_device_id ov13850_1140m_dt_match[] = {
	{.compatible = "htc,ov13850_1140m", .data = &ov13850_1140m_s_ctrl},
	{}
};

MODULE_DEVICE_TABLE(of, ov13850_1140m_dt_match);

static struct platform_driver ov13850_1140m_platform_driver = {
	.driver = {
		.name = "htc,ov13850_1140m",
		.owner = THIS_MODULE,
		.of_match_table = ov13850_1140m_dt_match,
	},
};

static const char *ov13850_1140mVendor = "OmniVision";
static const char *ov13850_1140mNAME = "ov13850_1140m";
static const char *ov13850_1140mSize = "13.0M";
		...
		struct device_attribute *attr, char *buf)
{
	...
	sprintf(buf, "%s %s %s\n", ov13850_1140mVendor, ov13850_1140mNAME, ov13850_1140mSize);
	ret = strlen(buf) + 1;
...
static struct kobject *android_ov13850_1140m;

static int ov13850_1140m_sysfs_init(void)
{
	int ret ;
	pr_info("ov13850_1140m:kobject creat and add\n");
	android_ov13850_1140m = kobject_create_and_add("android_camera", NULL);
	if (android_ov13850_1140m == NULL) {
		pr_info("ov13850_1140m_sysfs_init: subsystem_register " \
		"failed\n");
		ret = -ENOMEM;
		return ret ;
	}
	pr_info("ov13850_1140m:sysfs_create_file\n");
	ret = sysfs_create_file(android_ov13850_1140m, &dev_attr_sensor.attr);
	if (ret) {
		pr_info("ov13850_1140m_sysfs_init: sysfs_create_file " \
		"failed\n");
		kobject_del(android_ov13850_1140m);
	}

	ret = sysfs_create_file(android_ov13850_1140m, &dev_attr_otp_info.attr);
	if (ret) {
		pr_info("ov13850_1140m_sysfs_init: sysfs_create_file " \
		"failed\n");
	}
...
static int __init ov13850_1140m_init_module(void)
{
	int32_t rc = 0;
	pr_info("%s:%d\n", __func__, __LINE__);
	rc = platform_driver_probe(&ov13850_1140m_platform_driver,
		ov13850_1140m_platform_probe);
	if (!rc) {
		ov13850_1140m_sysfs_init();
		return rc;
	}
	pr_err("%s:%d rc %d\n", __func__, __LINE__, rc);
	return i2c_add_driver(&ov13850_1140m_i2c_driver);
}
...
int32_t ov13850_1140m_read_otp_memory(uint8_t *otpPtr, struct msm_sensor_ctrl_t *s_ctrl)
{
...
static void ov13850_1140m_parse_otp_mem(struct msm_sensor_ctrl_t *s_ctrl)
{
...
int32_t ov13850_1140m_sensor_match_id(struct msm_sensor_ctrl_t *s_ctrl)
{
	int32_t rc = 0;
	int32_t rc1 = 0;
	static int first = 0;
	...
	if(rc == 0) {
		if(first == 0) {
			rc1 = ov13850_1140m_read_otp_memory(otp_mem, s_ctrl);
			ov13850_1140m_parse_otp_mem(s_ctrl);
			if (rc1<0) {
				pr_err("%s: ov13850_1140m_read_otp_memory failed %d\n", __func__, rc1);
			} else
				first = 1;
		}
	}
...
static struct msm_sensor_fn_t ov13850_1140m_sensor_func_tbl = {
	.sensor_config = msm_sensor_config,
	.sensor_power_up = msm_sensor_power_up,
	.sensor_power_down = msm_sensor_power_down,
    
	.sensor_match_id = ov13850_1140m_sensor_match_id,
	
	.sensor_i2c_read_fuseid = ov13850_1140m_read_fuseid,
};

static struct msm_sensor_ctrl_t ov13850_1140m_s_ctrl = {
	.sensor_i2c_client = &ov13850_1140m_sensor_i2c_client,
	.power_setting_array.power_setting = ov13850_1140m_power_setting,
	.power_setting_array.size = ARRAY_SIZE(ov13850_1140m_power_setting),
	.msm_sensor_mutex = &ov13850_1140m_mut,
	.sensor_v4l2_subdev_info = ov13850_1140m_subdev_info,
	.sensor_v4l2_subdev_info_size = ARRAY_SIZE(ov13850_1140m_subdev_info),
	.func_tbl = &ov13850_1140m_sensor_func_tbl,
};

module_init(ov13850_1140m_init_module);
module_exit(ov13850_1140m_exit_module);
MODULE_DESCRIPTION("ov13850_1140m");
