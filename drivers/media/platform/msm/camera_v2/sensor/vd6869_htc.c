...
#define VD6869_SENSOR_NAME "vd6869_htc"
#define PLATFORM_DRIVER_NAME "msm_camera_vd6869_htc"
#define vd6869_obj vd6869_htc_##obj
...
static struct msm_sensor_power_setting vd6869_power_down_setting[] = {
	{
		.seq_type = SENSOR_I2C_MUX,
		.seq_val = 0,
		.config_val = 0,
...
static const struct of_device_id vd6869_dt_match[] = {
	{.compatible = "htc,vd6869_htc", .data = &vd6869_s_ctrl},
	{}
};
...
static const char *vd6869NAME = "vd6869_htc";
...
static struct msm_sensor_ctrl_t vd6869_s_ctrl = {
	...
	.power_setting_array.power_down_setting = vd6869_power_down_setting,
	.power_setting_array.size_down = ARRAY_SIZE(vd6869_power_down_setting),
